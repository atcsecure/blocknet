...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat May 23 19:29:51 2015
...
CC            = clang
CXX           = clang++
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DDEBUG_LOCKORDER -DIS_ARCH_64 -DUSE_UPNP=1 -DSTATICLIB -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_NO_DEBUG -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
CFLAGS        = -pipe -mmacosx-version-min=10.7 -O2 -arch x86_64 -pthread -Wall -W $(DEFINES)
CXXFLAGS      = -fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2 -arch x86_64 -pthread -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
/Users/whit/blocknet/src/leveldb/libleveldb.a: FORCE
	cd /Users/whit/blocknet/src/leveldb && CC=clang CXX=clang++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a
